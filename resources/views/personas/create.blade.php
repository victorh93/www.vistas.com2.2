                    ...
                    <div class="col-lg-12">
                        <div class="p-5">
                            <div class="text-center">
                                <h1 class="h4 text-gray-900 mb-4">Registro De Personas</h1>
                            </div>
                            ...
                            <form class="user" action="{{url('personas')}}" method="post">
                                @csrf
                                ...
                                <div class="form-group row">
                                    <div class="col-sm-6 mb-3 mb-sm-0"><br>
                                        <input type="text" class="form-control form-control-user"
                                            id="nroDoc" name="nroDoc" placeholder="Nro. Documento">
                                    </div>
                                    <div class="col-sm-6">
                                ...
                                <div class="form-group row">
                                    <div class="col-sm-6 ">
                                        <select name="select1" id="select1" class="form-control rounded-pill">
